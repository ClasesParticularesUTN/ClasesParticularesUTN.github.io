...
function enviar(urlFinal) {
  ...
  fetch(urlFinal).then(response => {
      ...
      .then(data => {
              ...
              if (document.referrer !== "" && document.referrer != "https://clasesparticularesutn.com.ar/Horarios/Registro/Registro.html" && document.referrer != "http://127.0.0.1:5501/Horarios/Login/Login.html") {
